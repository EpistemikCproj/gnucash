...
libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/test-modsysver.c.o: common/config.h
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/test-modsysver.c.o"
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/libgnucash/gnc-module/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test-modsysver.dir/test-modsysver.c.o   -c /home/marksa/dev/git/fork/gnucash/libgnucash/gnc-module/test/test-modsysver.c
...
libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/test-modsysver.c.i: cmake_force
	...
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/libgnucash/gnc-module/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/marksa/dev/git/fork/gnucash/libgnucash/gnc-module/test/test-modsysver.c > CMakeFiles/test-modsysver.dir/test-modsysver.c.i
...
libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/test-modsysver.c.s: cmake_force
	...
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/libgnucash/gnc-module/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/marksa/dev/git/fork/gnucash/libgnucash/gnc-module/test/test-modsysver.c -o CMakeFiles/test-modsysver.dir/test-modsysver.c.s
...
bin/test-modsysver: libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable ../../../bin/test-modsysver"
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/libgnucash/gnc-module/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-modsysver.dir/link.txt --verbose=$(VERBOSE)
...
libgnucash/gnc-module/test/CMakeFiles/test-modsysver.dir/clean:
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/libgnucash/gnc-module/test && $(CMAKE_COMMAND) -P CMakeFiles/test-modsysver.dir/cmake_clean.cmake
