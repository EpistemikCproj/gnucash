...
gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/test-link-module.c.o: common/config.h
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/test-link-module.c.o"
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/gnucash/register/register-core/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/test-link-module-register-core.dir/test-link-module.c.o   -c /home/marksa/dev/git/fork/gnucash/gnucash/register/register-core/test/test-link-module.c
...
gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/test-link-module.c.i: cmake_force
	...
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/gnucash/register/register-core/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /home/marksa/dev/git/fork/gnucash/gnucash/register/register-core/test/test-link-module.c > CMakeFiles/test-link-module-register-core.dir/test-link-module.c.i
...
gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/test-link-module.c.s: cmake_force
	...
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/gnucash/register/register-core/test && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /home/marksa/dev/git/fork/gnucash/gnucash/register/register-core/test/test-link-module.c -o CMakeFiles/test-link-module-register-core.dir/test-link-module.c.s
...
bin/test-link-module-register-core: gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable ../../../../bin/test-link-module-register-core"
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/gnucash/register/register-core/test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/test-link-module-register-core.dir/link.txt --verbose=$(VERBOSE)
...
gnucash/register/register-core/test/CMakeFiles/test-link-module-register-core.dir/clean:
	cd /home/marksa/dev/git/fork/gnucash/build-gnucash-3.4-stable/gnucash/register/register-core/test && $(CMAKE_COMMAND) -P CMakeFiles/test-link-module-register-core.dir/cmake_clean.cmake
