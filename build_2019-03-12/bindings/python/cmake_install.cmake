...
file(INSTALL DESTINATION "/opt/gnucash/lib/python3.6/site-packages/gnucash" TYPE MODULE FILES "/home/marksa/dev/git/fork/gnucash/build_2019-03-13/lib/gnucash/_gnucash_core_c.so")
  if(EXISTS "$ENV{DESTDIR}/opt/gnucash/lib/python3.6/site-packages/gnucash/_gnucash_core_c.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/opt/gnucash/lib/python3.6/site-packages/gnucash/_gnucash_core_c.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/opt/gnucash/lib/python3.6/site-packages/gnucash/_gnucash_core_c.so"
...
file(INSTALL DESTINATION "/opt/gnucash/lib/python3.6/site-packages/gnucash" TYPE FILE FILES
    ...
    "/home/marksa/dev/git/fork/gnucash/build_2019-03-13/bindings/python/gnucash_core_c.py"
    )
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  include("/home/marksa/dev/git/fork/gnucash/build_2019-03-13/bindings/python/example_scripts/cmake_install.cmake")
  include("/home/marksa/dev/git/fork/gnucash/build_2019-03-13/bindings/python/tests/cmake_install.cmake")
